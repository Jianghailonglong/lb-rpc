...
#ifndef GOOGLE_PROTOBUF_INCLUDED_lbrss_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_lbrss_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_lbrss_2eproto
...
struct TableStruct_lbrss_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lbrss_2eproto;
namespace lbrss {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::lbrss::GetHostRequest* Arena::CreateMaybeMessage<::lbrss::GetHostRequest>(Arena*);
template<> ::lbrss::GetHostResponse* Arena::CreateMaybeMessage<::lbrss::GetHostResponse>(Arena*);
template<> ::lbrss::GetRouteRequest* Arena::CreateMaybeMessage<::lbrss::GetRouteRequest>(Arena*);
template<> ::lbrss::GetRouteResponse* Arena::CreateMaybeMessage<::lbrss::GetRouteResponse>(Arena*);
template<> ::lbrss::HostCallResult* Arena::CreateMaybeMessage<::lbrss::HostCallResult>(Arena*);
template<> ::lbrss::HostInfo* Arena::CreateMaybeMessage<::lbrss::HostInfo>(Arena*);
template<> ::lbrss::ReportRequest* Arena::CreateMaybeMessage<::lbrss::ReportRequest>(Arena*);
template<> ::lbrss::ReportStatusRequest* Arena::CreateMaybeMessage<::lbrss::ReportStatusRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace lbrss {
...
constexpr RetCode RetCode_MIN = RET_SUCC;
constexpr RetCode RetCode_MAX = RET_NOEXIST;
...
class HostInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.HostInfo) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_lbrss_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:lbrss.HostInfo)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_lbrss_2eproto;
};
// -------------------------------------------------------------------

class GetRouteRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.GetRouteRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrss.GetRouteRequest)
 private:
  class _Internal;
...
class GetRouteResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.GetRouteResponse) */ {
 public:
  ...
  public:
  void clear_host();
  ::lbrss::HostInfo* mutable_host(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostInfo >*
      mutable_host();
  private:
  const ::lbrss::HostInfo& _internal_host(int index) const;
  ::lbrss::HostInfo* _internal_add_host();
  public:
  const ::lbrss::HostInfo& host(int index) const;
  ::lbrss::HostInfo* add_host();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostInfo >&
      host() const;
  ...
  // @@protoc_insertion_point(class_scope:lbrss.GetRouteResponse)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostInfo > host_;
  ::PROTOBUF_NAMESPACE_ID::int32 modid_;
  ::PROTOBUF_NAMESPACE_ID::int32 cmdid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_lbrss_2eproto;
...
class HostCallResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.HostCallResult) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrss.HostCallResult)
 private:
  class _Internal;
...
class ReportStatusRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.ReportStatusRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lbrss.ReportStatusRequest";
  }
  protected:
  ...
  public:
  void clear_results();
  ::lbrss::HostCallResult* mutable_results(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostCallResult >*
      mutable_results();
  private:
  const ::lbrss::HostCallResult& _internal_results(int index) const;
  ::lbrss::HostCallResult* _internal_add_results();
  public:
  const ::lbrss::HostCallResult& results(int index) const;
  ::lbrss::HostCallResult* add_results();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostCallResult >&
      results() const;
  ...
  // @@protoc_insertion_point(class_scope:lbrss.ReportStatusRequest)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostCallResult > results_;
  ::PROTOBUF_NAMESPACE_ID::int32 modid_;
  ::PROTOBUF_NAMESPACE_ID::int32 cmdid_;
...
class GetHostRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.GetHostRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrss.GetHostRequest)
 private:
  class _Internal;
...
class GetHostResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.GetHostResponse) */ {
 public:
  ...
  public:
  void clear_host();
  const ::lbrss::HostInfo& host() const;
  ::lbrss::HostInfo* release_host();
  ::lbrss::HostInfo* mutable_host();
  void set_allocated_host(::lbrss::HostInfo* host);
  private:
  const ::lbrss::HostInfo& _internal_host() const;
  ::lbrss::HostInfo* _internal_mutable_host();
  public:
  void unsafe_arena_set_allocated_host(
      ::lbrss::HostInfo* host);
  ::lbrss::HostInfo* unsafe_arena_release_host();
  ...
  // @@protoc_insertion_point(class_scope:lbrss.GetHostResponse)
 private:
  class _Internal;
...
class ReportRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrss.ReportRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrss.ReportRequest)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostInfo::ip() const {
  // @@protoc_insertion_point(field_get:lbrss.HostInfo.ip)
  return _internal_ip();
}
...
inline void HostInfo::set_ip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.HostInfo.ip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostInfo::port() const {
  // @@protoc_insertion_point(field_get:lbrss.HostInfo.port)
...
inline void HostInfo::set_port(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.HostInfo.port)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetRouteRequest.modid)
...
inline void GetRouteRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.GetRouteRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetRouteRequest.cmdid)
...
inline void GetRouteRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.GetRouteRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteResponse::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetRouteResponse.modid)
  return _internal_modid();
}
...
inline void GetRouteResponse::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetRouteResponse.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteResponse::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetRouteResponse.cmdid)
  return _internal_cmdid();
}
...
inline void GetRouteResponse::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetRouteResponse.cmdid)
}
...
inline ::lbrss::HostInfo* GetRouteResponse::mutable_host(int index) {
  // @@protoc_insertion_point(field_mutable:lbrss.GetRouteResponse.host)
  return host_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostInfo >*
GetRouteResponse::mutable_host() {
  // @@protoc_insertion_point(field_mutable_list:lbrss.GetRouteResponse.host)
  return &host_;
}
inline const ::lbrss::HostInfo& GetRouteResponse::_internal_host(int index) const {
  return host_.Get(index);
}
inline const ::lbrss::HostInfo& GetRouteResponse::host(int index) const {
  // @@protoc_insertion_point(field_get:lbrss.GetRouteResponse.host)
  return _internal_host(index);
}
inline ::lbrss::HostInfo* GetRouteResponse::_internal_add_host() {
  return host_.Add();
}
inline ::lbrss::HostInfo* GetRouteResponse::add_host() {
  // @@protoc_insertion_point(field_add:lbrss.GetRouteResponse.host)
  return _internal_add_host();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostInfo >&
GetRouteResponse::host() const {
  // @@protoc_insertion_point(field_list:lbrss.GetRouteResponse.host)
  return host_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostCallResult::ip() const {
  // @@protoc_insertion_point(field_get:lbrss.HostCallResult.ip)
  return _internal_ip();
}
...
inline void HostCallResult::set_ip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_ip(value);
  // @@protoc_insertion_point(field_set:lbrss.HostCallResult.ip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostCallResult::port() const {
  // @@protoc_insertion_point(field_get:lbrss.HostCallResult.port)
  return _internal_port();
}
...
inline void HostCallResult::set_port(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:lbrss.HostCallResult.port)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 HostCallResult::succ() const {
  // @@protoc_insertion_point(field_get:lbrss.HostCallResult.succ)
...
inline void HostCallResult::set_succ(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.HostCallResult.succ)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 HostCallResult::err() const {
  // @@protoc_insertion_point(field_get:lbrss.HostCallResult.err)
...
inline void HostCallResult::set_err(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.HostCallResult.err)
}
...
inline bool HostCallResult::overload() const {
  // @@protoc_insertion_point(field_get:lbrss.HostCallResult.overload)
...
inline void HostCallResult::set_overload(bool value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.HostCallResult.overload)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportStatusRequest.modid)
  return _internal_modid();
}
...
inline void ReportStatusRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrss.ReportStatusRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportStatusRequest.cmdid)
  return _internal_cmdid();
}
...
inline void ReportStatusRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrss.ReportStatusRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::caller() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportStatusRequest.caller)
...
inline void ReportStatusRequest::set_caller(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.ReportStatusRequest.caller)
}
...
inline ::lbrss::HostCallResult* ReportStatusRequest::mutable_results(int index) {
  // @@protoc_insertion_point(field_mutable:lbrss.ReportStatusRequest.results)
  return results_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostCallResult >*
ReportStatusRequest::mutable_results() {
  // @@protoc_insertion_point(field_mutable_list:lbrss.ReportStatusRequest.results)
  return &results_;
}
inline const ::lbrss::HostCallResult& ReportStatusRequest::_internal_results(int index) const {
  return results_.Get(index);
}
inline const ::lbrss::HostCallResult& ReportStatusRequest::results(int index) const {
  // @@protoc_insertion_point(field_get:lbrss.ReportStatusRequest.results)
  return _internal_results(index);
}
inline ::lbrss::HostCallResult* ReportStatusRequest::_internal_add_results() {
  return results_.Add();
}
inline ::lbrss::HostCallResult* ReportStatusRequest::add_results() {
  // @@protoc_insertion_point(field_add:lbrss.ReportStatusRequest.results)
  return _internal_add_results();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrss::HostCallResult >&
ReportStatusRequest::results() const {
  // @@protoc_insertion_point(field_list:lbrss.ReportStatusRequest.results)
  return results_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ReportStatusRequest::ts() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportStatusRequest.ts)
  return _internal_ts();
}
...
inline void ReportStatusRequest::set_ts(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.ReportStatusRequest.ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetHostRequest::seq() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostRequest.seq)
...
inline void GetHostRequest::set_seq(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.GetHostRequest.seq)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostRequest.modid)
  return _internal_modid();
}
...
inline void GetHostRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetHostRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostRequest.cmdid)
  return _internal_cmdid();
}
...
inline void GetHostRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetHostRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetHostResponse::seq() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostResponse.seq)
  return _internal_seq();
}
...
inline void GetHostResponse::set_seq(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_seq(value);
  // @@protoc_insertion_point(field_set:lbrss.GetHostResponse.seq)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostResponse.modid)
  return _internal_modid();
}
...
inline void GetHostResponse::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetHostResponse.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostResponse.cmdid)
  return _internal_cmdid();
}
...
inline void GetHostResponse::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrss.GetHostResponse.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::retcode() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostResponse.retcode)
...
inline void GetHostResponse::set_retcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrss.GetHostResponse.retcode)
}
...
inline const ::lbrss::HostInfo& GetHostResponse::_internal_host() const {
  const ::lbrss::HostInfo* p = host_;
  return p != nullptr ? *p : *reinterpret_cast<const ::lbrss::HostInfo*>(
      &::lbrss::_HostInfo_default_instance_);
}
inline const ::lbrss::HostInfo& GetHostResponse::host() const {
  // @@protoc_insertion_point(field_get:lbrss.GetHostResponse.host)
...
inline void GetHostResponse::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:lbrss.GetHostResponse.host)
}
inline ::lbrss::HostInfo* GetHostResponse::release_host() {
  
  ::lbrss::HostInfo* temp = host_;
  host_ = nullptr;
  if (GetArena() != nullptr) {
...
inline ::lbrss::HostInfo* GetHostResponse::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_release:lbrss.GetHostResponse.host)
  
  ::lbrss::HostInfo* temp = host_;
  host_ = nullptr;
  return temp;
}
inline ::lbrss::HostInfo* GetHostResponse::_internal_mutable_host() {
  
  if (host_ == nullptr) {
    auto* p = CreateMaybeMessage<::lbrss::HostInfo>(GetArena());
    host_ = p;
  }
  return host_;
}
inline ::lbrss::HostInfo* GetHostResponse::mutable_host() {
  // @@protoc_insertion_point(field_mutable:lbrss.GetHostResponse.host)
  return _internal_mutable_host();
}
inline void GetHostResponse::set_allocated_host(::lbrss::HostInfo* host) {
  ...
  host_ = host;
  // @@protoc_insertion_point(field_set_allocated:lbrss.GetHostResponse.host)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::_internal_modid() const {
  return modid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportRequest.modid)
  return _internal_modid();
}
inline void ReportRequest::_internal_set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  modid_ = value;
}
inline void ReportRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrss.ReportRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::_internal_cmdid() const {
  return cmdid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportRequest.cmdid)
  return _internal_cmdid();
}
inline void ReportRequest::_internal_set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  cmdid_ = value;
}
inline void ReportRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrss.ReportRequest.cmdid)
}
...
inline const ::lbrss::HostInfo& ReportRequest::_internal_host() const {
  const ::lbrss::HostInfo* p = host_;
  return p != nullptr ? *p : *reinterpret_cast<const ::lbrss::HostInfo*>(
      &::lbrss::_HostInfo_default_instance_);
}
inline const ::lbrss::HostInfo& ReportRequest::host() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportRequest.host)
  return _internal_host();
}
inline void ReportRequest::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:lbrss.ReportRequest.host)
}
inline ::lbrss::HostInfo* ReportRequest::release_host() {
...
inline ::lbrss::HostInfo* ReportRequest::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_release:lbrss.ReportRequest.host)
  
  ::lbrss::HostInfo* temp = host_;
  host_ = nullptr;
  return temp;
}
inline ::lbrss::HostInfo* ReportRequest::_internal_mutable_host() {
...
inline ::lbrss::HostInfo* ReportRequest::mutable_host() {
  // @@protoc_insertion_point(field_mutable:lbrss.ReportRequest.host)
  return _internal_mutable_host();
}
inline void ReportRequest::set_allocated_host(::lbrss::HostInfo* host) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete host_;
  }
  ...
  host_ = host;
  // @@protoc_insertion_point(field_set_allocated:lbrss.ReportRequest.host)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::retcode() const {
  // @@protoc_insertion_point(field_get:lbrss.ReportRequest.retcode)
  return _internal_retcode();
}
...
inline void ReportRequest::set_retcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_retcode(value);
  // @@protoc_insertion_point(field_set:lbrss.ReportRequest.retcode)
}
...
template <> struct is_proto_enum< ::lbrss::MessageId> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::lbrss::MessageId>() {
  return ::lbrss::MessageId_descriptor();
}
template <> struct is_proto_enum< ::lbrss::RetCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::lbrss::RetCode>() {
  return ::lbrss::RetCode_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_lbrss_2eproto
