...
#ifndef GOOGLE_PROTOBUF_INCLUDED_lbrpc_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_lbrpc_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_lbrpc_2eproto
...
struct TableStruct_lbrpc_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lbrpc_2eproto;
namespace lbrpc {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::lbrpc::GetHostRequest* Arena::CreateMaybeMessage<::lbrpc::GetHostRequest>(Arena*);
template<> ::lbrpc::GetHostResponse* Arena::CreateMaybeMessage<::lbrpc::GetHostResponse>(Arena*);
template<> ::lbrpc::GetRouteRequest* Arena::CreateMaybeMessage<::lbrpc::GetRouteRequest>(Arena*);
template<> ::lbrpc::GetRouteResponse* Arena::CreateMaybeMessage<::lbrpc::GetRouteResponse>(Arena*);
template<> ::lbrpc::HostCallResult* Arena::CreateMaybeMessage<::lbrpc::HostCallResult>(Arena*);
template<> ::lbrpc::HostInfo* Arena::CreateMaybeMessage<::lbrpc::HostInfo>(Arena*);
template<> ::lbrpc::ReportRequest* Arena::CreateMaybeMessage<::lbrpc::ReportRequest>(Arena*);
template<> ::lbrpc::ReportStatusRequest* Arena::CreateMaybeMessage<::lbrpc::ReportStatusRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace lbrpc {
...
class HostInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.HostInfo) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_lbrpc_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.HostInfo)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_lbrpc_2eproto;
};
// -------------------------------------------------------------------

class GetRouteRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.GetRouteRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.GetRouteRequest)
 private:
  class _Internal;
...
class GetRouteResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.GetRouteResponse) */ {
 public:
  ...
  public:
  void clear_host();
  ::lbrpc::HostInfo* mutable_host(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostInfo >*
      mutable_host();
  private:
  const ::lbrpc::HostInfo& _internal_host(int index) const;
  ::lbrpc::HostInfo* _internal_add_host();
  public:
  const ::lbrpc::HostInfo& host(int index) const;
  ::lbrpc::HostInfo* add_host();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostInfo >&
      host() const;
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.GetRouteResponse)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostInfo > host_;
  ::PROTOBUF_NAMESPACE_ID::int32 modid_;
  ::PROTOBUF_NAMESPACE_ID::int32 cmdid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_lbrpc_2eproto;
...
class HostCallResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.HostCallResult) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.HostCallResult)
 private:
  class _Internal;
...
class ReportStatusRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.ReportStatusRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lbrpc.ReportStatusRequest";
  }
  protected:
  ...
  public:
  void clear_results();
  ::lbrpc::HostCallResult* mutable_results(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostCallResult >*
      mutable_results();
  private:
  const ::lbrpc::HostCallResult& _internal_results(int index) const;
  ::lbrpc::HostCallResult* _internal_add_results();
  public:
  const ::lbrpc::HostCallResult& results(int index) const;
  ::lbrpc::HostCallResult* add_results();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostCallResult >&
      results() const;
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.ReportStatusRequest)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostCallResult > results_;
  ::PROTOBUF_NAMESPACE_ID::int32 modid_;
  ::PROTOBUF_NAMESPACE_ID::int32 cmdid_;
...
class GetHostRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.GetHostRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.GetHostRequest)
 private:
  class _Internal;
...
class GetHostResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.GetHostResponse) */ {
 public:
  ...
  public:
  void clear_host();
  const ::lbrpc::HostInfo& host() const;
  ::lbrpc::HostInfo* release_host();
  ::lbrpc::HostInfo* mutable_host();
  void set_allocated_host(::lbrpc::HostInfo* host);
  private:
  const ::lbrpc::HostInfo& _internal_host() const;
  ::lbrpc::HostInfo* _internal_mutable_host();
  public:
  void unsafe_arena_set_allocated_host(
      ::lbrpc::HostInfo* host);
  ::lbrpc::HostInfo* unsafe_arena_release_host();
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.GetHostResponse)
 private:
  class _Internal;
...
class ReportRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lbrpc.ReportRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:lbrpc.ReportRequest)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostInfo::ip() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostInfo.ip)
  return _internal_ip();
}
...
inline void HostInfo::set_ip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.HostInfo.ip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostInfo::port() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostInfo.port)
...
inline void HostInfo::set_port(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.HostInfo.port)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetRouteRequest.modid)
...
inline void GetRouteRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.GetRouteRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetRouteRequest.cmdid)
...
inline void GetRouteRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.GetRouteRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteResponse::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetRouteResponse.modid)
  return _internal_modid();
}
...
inline void GetRouteResponse::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetRouteResponse.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetRouteResponse::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetRouteResponse.cmdid)
  return _internal_cmdid();
}
...
inline void GetRouteResponse::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetRouteResponse.cmdid)
}
...
inline ::lbrpc::HostInfo* GetRouteResponse::mutable_host(int index) {
  // @@protoc_insertion_point(field_mutable:lbrpc.GetRouteResponse.host)
  return host_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostInfo >*
GetRouteResponse::mutable_host() {
  // @@protoc_insertion_point(field_mutable_list:lbrpc.GetRouteResponse.host)
  return &host_;
}
inline const ::lbrpc::HostInfo& GetRouteResponse::_internal_host(int index) const {
  return host_.Get(index);
}
inline const ::lbrpc::HostInfo& GetRouteResponse::host(int index) const {
  // @@protoc_insertion_point(field_get:lbrpc.GetRouteResponse.host)
  return _internal_host(index);
}
inline ::lbrpc::HostInfo* GetRouteResponse::_internal_add_host() {
  return host_.Add();
}
inline ::lbrpc::HostInfo* GetRouteResponse::add_host() {
  // @@protoc_insertion_point(field_add:lbrpc.GetRouteResponse.host)
  return _internal_add_host();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostInfo >&
GetRouteResponse::host() const {
  // @@protoc_insertion_point(field_list:lbrpc.GetRouteResponse.host)
  return host_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostCallResult::ip() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostCallResult.ip)
  return _internal_ip();
}
...
inline void HostCallResult::set_ip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_ip(value);
  // @@protoc_insertion_point(field_set:lbrpc.HostCallResult.ip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 HostCallResult::port() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostCallResult.port)
  return _internal_port();
}
...
inline void HostCallResult::set_port(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:lbrpc.HostCallResult.port)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 HostCallResult::succ() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostCallResult.succ)
...
inline void HostCallResult::set_succ(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.HostCallResult.succ)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 HostCallResult::err() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostCallResult.err)
...
inline void HostCallResult::set_err(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.HostCallResult.err)
}
...
inline bool HostCallResult::overload() const {
  // @@protoc_insertion_point(field_get:lbrpc.HostCallResult.overload)
...
inline void HostCallResult::set_overload(bool value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.HostCallResult.overload)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportStatusRequest.modid)
  return _internal_modid();
}
...
inline void ReportStatusRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrpc.ReportStatusRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportStatusRequest.cmdid)
  return _internal_cmdid();
}
...
inline void ReportStatusRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrpc.ReportStatusRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportStatusRequest::caller() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportStatusRequest.caller)
...
inline void ReportStatusRequest::set_caller(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.ReportStatusRequest.caller)
}
...
inline ::lbrpc::HostCallResult* ReportStatusRequest::mutable_results(int index) {
  // @@protoc_insertion_point(field_mutable:lbrpc.ReportStatusRequest.results)
  return results_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostCallResult >*
ReportStatusRequest::mutable_results() {
  // @@protoc_insertion_point(field_mutable_list:lbrpc.ReportStatusRequest.results)
  return &results_;
}
inline const ::lbrpc::HostCallResult& ReportStatusRequest::_internal_results(int index) const {
  return results_.Get(index);
}
inline const ::lbrpc::HostCallResult& ReportStatusRequest::results(int index) const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportStatusRequest.results)
  return _internal_results(index);
}
inline ::lbrpc::HostCallResult* ReportStatusRequest::_internal_add_results() {
  return results_.Add();
}
inline ::lbrpc::HostCallResult* ReportStatusRequest::add_results() {
  // @@protoc_insertion_point(field_add:lbrpc.ReportStatusRequest.results)
  return _internal_add_results();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::lbrpc::HostCallResult >&
ReportStatusRequest::results() const {
  // @@protoc_insertion_point(field_list:lbrpc.ReportStatusRequest.results)
  return results_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ReportStatusRequest::ts() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportStatusRequest.ts)
  return _internal_ts();
}
...
inline void ReportStatusRequest::set_ts(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.ReportStatusRequest.ts)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetHostRequest::seq() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostRequest.seq)
...
inline void GetHostRequest::set_seq(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.GetHostRequest.seq)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostRequest.modid)
  return _internal_modid();
}
...
inline void GetHostRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetHostRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostRequest.cmdid)
  return _internal_cmdid();
}
...
inline void GetHostRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetHostRequest.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetHostResponse::seq() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostResponse.seq)
  return _internal_seq();
}
...
inline void GetHostResponse::set_seq(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_seq(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetHostResponse.seq)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostResponse.modid)
  return _internal_modid();
}
...
inline void GetHostResponse::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetHostResponse.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostResponse.cmdid)
  return _internal_cmdid();
}
...
inline void GetHostResponse::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrpc.GetHostResponse.cmdid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 GetHostResponse::retcode() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostResponse.retcode)
...
inline void GetHostResponse::set_retcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:lbrpc.GetHostResponse.retcode)
}
...
inline const ::lbrpc::HostInfo& GetHostResponse::_internal_host() const {
  const ::lbrpc::HostInfo* p = host_;
  return p != nullptr ? *p : *reinterpret_cast<const ::lbrpc::HostInfo*>(
      &::lbrpc::_HostInfo_default_instance_);
}
inline const ::lbrpc::HostInfo& GetHostResponse::host() const {
  // @@protoc_insertion_point(field_get:lbrpc.GetHostResponse.host)
...
inline void GetHostResponse::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:lbrpc.GetHostResponse.host)
}
inline ::lbrpc::HostInfo* GetHostResponse::release_host() {
  
  ::lbrpc::HostInfo* temp = host_;
  host_ = nullptr;
  if (GetArena() != nullptr) {
...
inline ::lbrpc::HostInfo* GetHostResponse::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_release:lbrpc.GetHostResponse.host)
  
  ::lbrpc::HostInfo* temp = host_;
  host_ = nullptr;
  return temp;
}
inline ::lbrpc::HostInfo* GetHostResponse::_internal_mutable_host() {
  
  if (host_ == nullptr) {
    auto* p = CreateMaybeMessage<::lbrpc::HostInfo>(GetArena());
    host_ = p;
  }
  return host_;
}
inline ::lbrpc::HostInfo* GetHostResponse::mutable_host() {
  // @@protoc_insertion_point(field_mutable:lbrpc.GetHostResponse.host)
  return _internal_mutable_host();
}
inline void GetHostResponse::set_allocated_host(::lbrpc::HostInfo* host) {
  ...
  host_ = host;
  // @@protoc_insertion_point(field_set_allocated:lbrpc.GetHostResponse.host)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::modid() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportRequest.modid)
  return _internal_modid();
}
...
inline void ReportRequest::set_modid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_modid(value);
  // @@protoc_insertion_point(field_set:lbrpc.ReportRequest.modid)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::cmdid() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportRequest.cmdid)
  return _internal_cmdid();
}
...
inline void ReportRequest::set_cmdid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_cmdid(value);
  // @@protoc_insertion_point(field_set:lbrpc.ReportRequest.cmdid)
}
...
inline const ::lbrpc::HostInfo& ReportRequest::_internal_host() const {
  const ::lbrpc::HostInfo* p = host_;
  return p != nullptr ? *p : *reinterpret_cast<const ::lbrpc::HostInfo*>(
      &::lbrpc::_HostInfo_default_instance_);
}
inline const ::lbrpc::HostInfo& ReportRequest::host() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportRequest.host)
  return _internal_host();
}
inline void ReportRequest::unsafe_arena_set_allocated_host(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:lbrpc.ReportRequest.host)
}
inline ::lbrpc::HostInfo* ReportRequest::release_host() {
...
inline ::lbrpc::HostInfo* ReportRequest::unsafe_arena_release_host() {
  // @@protoc_insertion_point(field_release:lbrpc.ReportRequest.host)
  
  ::lbrpc::HostInfo* temp = host_;
  host_ = nullptr;
  return temp;
}
inline ::lbrpc::HostInfo* ReportRequest::_internal_mutable_host() {
...
inline ::lbrpc::HostInfo* ReportRequest::mutable_host() {
  // @@protoc_insertion_point(field_mutable:lbrpc.ReportRequest.host)
  return _internal_mutable_host();
}
inline void ReportRequest::set_allocated_host(::lbrpc::HostInfo* host) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete host_;
  }
  ...
  host_ = host;
  // @@protoc_insertion_point(field_set_allocated:lbrpc.ReportRequest.host)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ReportRequest::retcode() const {
  // @@protoc_insertion_point(field_get:lbrpc.ReportRequest.retcode)
  return _internal_retcode();
}
...
inline void ReportRequest::set_retcode(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_retcode(value);
  // @@protoc_insertion_point(field_set:lbrpc.ReportRequest.retcode)
}
...
template <> struct is_proto_enum< ::lbrpc::MessageId> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::lbrpc::MessageId>() {
  return ::lbrpc::MessageId_descriptor();
}
template <> struct is_proto_enum< ::lbrpc::LarsRetCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::lbrpc::LarsRetCode>() {
  return ::lbrpc::LarsRetCode_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_lbrpc_2eproto
