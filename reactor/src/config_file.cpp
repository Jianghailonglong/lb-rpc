...
ConfigFile* ConfigFile::config = NULL;
...
// 获取字符串类型键值对
std::string ConfigFile::GetString(const std::string& section, const std::string& key, const std::string& default_value)
{
...
// 获取浮点类型键值对
float ConfigFile::GetFloat(const std::string& section, const std::string& key, const float& default_value)
{
...
std::vector<std::string> ConfigFile::GetStringList(const std::string& section, const std::string& key)
{
...
// 获取整型类型键值对
unsigned ConfigFile::GetNumber(const std::string& section, const std::string& key, unsigned default_value)
{
    STR_MAP_ITER it = _map.find(section);
    if (it != _map.end())
    {
...
unsigned ConfigFile::parseNumber(const std::string& s)
{
